TEXTO_1 = "Has cometido 3 errores, vuelve a introducir un numero."
TEXTO_2 = "Estos son los valores intercambios:"
TEXTO_3 = "Introduce un numero : "
TEXTO_4 = "Introduce un numero del 1 al 50: "
TEXTO_5 = "Introduce una nota del 1 al 10: "
...
def validate(txt):
    num = int(input(txt))
    i = 1
    while (num < 10 or num > 5000) and i != 3:
        num = int(input(txt))
        i += 1
    if i == 3:
        print(TEXTO_1)
